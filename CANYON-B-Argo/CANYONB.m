...
year=gvec(:,1)+(datenum(gtime(:))-datenum(gvec(:,1),1,1))./365;
...
data=[year(:) lat(:)/90 abs(1-mod(lon(:)-110,360)/180) abs(1-mod(lon(:)-20,360)/180) temp(:) psal(:) doxy(:) pres(:)./2e4+1./((1+exp(-pres(:)./300)).^3)];
